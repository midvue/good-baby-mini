...
<script lang="ts">
import { onMounted, onDeactivated, onActivated, reactive, ref, type PropType } from 'vue'
import { defineComponent } from 'vue'
import Taro, { eventCenter, getCurrentInstance } from '@tarojs/taro'
import { requestAnimationFrame } from '@mid-vue/shared'
...
export default defineComponent({
  ...
  setup(props) {
    ...
    onDeactivated(() => {
      ...
      dragRef.value.removeEventListener('touchstart', touchStart)
      dragRef.value.removeEventListener('touchmove', touchMove)
      dragRef.value.removeEventListener('touchend', touchEnd)
    })
    return {
      dragRef,
      touchStart,
